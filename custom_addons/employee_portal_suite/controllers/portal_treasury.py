...
class PortalTreasury(http.Controller):
    ...
    def treasury_payment_approvals(self, status='pending', **kw):
        ...
        return request.render('employee_portal_suite.portal_treasury_payment_list_v2', {
            'lines': lines,
            'counts': counts,
    ...
    def treasury_plans(self, **kw):
        ...
        return request.render('employee_portal_suite.portal_treasury_plan_list_v2', {
            'runs': runs,
    ...
    def treasury_plan_detail(self, run_id, **kw):
        ...
        return request.render('employee_portal_suite.portal_treasury_plan_detail_v2', {
            'run': run,
            'page_name': 'treasury_plans',
        })
