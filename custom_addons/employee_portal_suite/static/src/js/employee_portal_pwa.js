...
function enforceEmployeePortalFavicon() {
    ...
    const touchIcons = [
        ["apple-touch-icon", "", "/employee_portal_suite/static/icons/apple-touch-icon.png?v=43"],
        ["apple-touch-icon", "180x180", "/employee_portal_suite/static/icons/portal-180.png?v=43"],
        ["apple-touch-icon-precomposed", "", "/employee_portal_suite/static/icons/apple-touch-icon-precomposed.png?v=43"],
    ];
    ...
    const icons = [
        ["shortcut icon", "image/x-icon", "", "/employee_portal_suite/static/icons/portal-favicon-v43.ico?v=43"],
        ["icon", "image/png", "16x16", "/employee_portal_suite/static/icons/portal-16.png?v=43"],
        ["icon", "image/png", "32x32", "/employee_portal_suite/static/icons/portal-32.png?v=43"],
        ["icon", "image/png", "64x64", "/employee_portal_suite/static/icons/portal-64.png?v=43"],
    ];
