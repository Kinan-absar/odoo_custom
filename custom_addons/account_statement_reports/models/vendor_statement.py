...
class VendorStatement(models.Model):
    ...
    journal_ids = fields.Many2many("account.journal", "vendor_statement_journal_rel", "statement_id", "journal_id", readonly=True)
    account_ids = fields.Many2many("account.account", "vendor_statement_account_rel", "statement_id", "account_id", readonly=True)
