...
class AccountPaymentVoucher(models.Model):
    ...
    def retrieve_dashboard(self):
        ...
        return {
            ...
            'my_cash_count':     my_count([('payment_method', '=', 'cash')]),
            'my_cheque_count':   my_count([('payment_method', '=', 'cheque')]),
            'my_bank_count':     my_count([('payment_method', '=', 'bank_transfer')]),
            'my_transfer_count': my_count([('payment_method', '=', 'journal_transfer')]),
